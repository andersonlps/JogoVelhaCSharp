...
namespace JogoVelhaCSharp
{
    ...
    class Board
    {
        ...
        /// </summary>
        /// <param name="boadItem">BoardItem para converter.</param>
        /// <returns>Caractere resultante.</returns>
        public char ConvertBoardItemToChar(BoardItem boadItem)
        {
            switch (boadItem)
            {
                case BoardItem.X: return 'X';
                case BoardItem.O: return '0';
                default: return ' ';
            }
        }
        ...
        public void Play(int row, int col, BoardItem boardItem)
        {
            ...
            {
                //Se a jogada já foi realizada, lança uma exceção.
                throw new PlayException("Está jogada já foi realizada");
            }

            //Atribuí o item à posição do tabuleiro.
